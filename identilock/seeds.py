...
Every factual field can carry citations — see ``identilock/sources.py``. The
...
AGENCIES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "freeze_url": "https://www.firstdata.com/telecheck/consumer-information.html",
        "phone": "",
        "mail_address": "",
        "address_verified": False,
        "source_url": "https://www.firstdata.com/telecheck/consumer-information.html",
        "supports_online": False,
        "supports_minor": False,
        "minor_mail_only": True,
        "thaw_procedure": "Contact directly.",
        "notes": "",
        "citations": {"freeze_url": ["telecheck-consumer"]},
        "sort_order": 32,
    },
    {
        "slug": "certegy",
    ...
    # --------------------------------------------------------------- subprime
    {
        ...
        "freeze_url": "https://www.clarityservices.com/consumers/",
        "phone": "",
        "mail_address": "",
        "address_verified": False,
        "source_url": "https://www.clarityservices.com/consumers/",
        "supports_online": True,
        "supports_minor": False,
        "minor_mail_only": True,
        "thaw_procedure": "Contact directly.",
        "notes": "Separate from the main Experian freeze.",
        "citations": {"freeze_url": ["clarity-consumers"]},
        "sort_order": 50,
    },
    {
        "slug": "teletrack",
        "name": "Teletrack",
        "category": "subprime",
        "description": "Subprime lending bureau, owned by TransUnion.",
        "why_it_matters": "Same exposure as Clarity, different lender network.",
        "freeze_url": "https://teletrack.com/consumers/",
        "phone": "",
        "mail_address": "",
        "address_verified": False,
        "source_url": "https://teletrack.com/consumers/",
        "supports_online": True,
        "supports_minor": False,
        "minor_mail_only": True,
        "thaw_procedure": "Contact directly.",
        "notes": "Separate from the main TransUnion freeze.",
        "citations": {"freeze_url": ["teletrack-consumers"]},
        "sort_order": 51,
    },
    # ----------------------------------------------------------------- rental
    {
        ...
        "category": "rental",
        "description": "Tenant screening and rental history.",
        "why_it_matters": "Used by landlords; errors here can cost you a lease.",
        "freeze_url": "https://consumers.corelogic.com/",
        "phone": "",
        "mail_address": "",
        "address_verified": False,
        "source_url": "https://consumers.corelogic.com/",
        "supports_online": True,
        "supports_minor": False,
        "minor_mail_only": True,
        "thaw_procedure": "Contact directly.",
        "notes": "",
        "citations": {"freeze_url": ["corelogic-consumers"]},
        "sort_order": 60,
    },
    {
        "slug": "realpage",
        ...
        "freeze_url": "https://www.realpage.com/consumer/",
        "phone": "",
        "mail_address": "",
        "address_verified": False,
        "source_url": "https://www.realpage.com/consumer/",
        "supports_online": True,
        "supports_minor": False,
        "minor_mail_only": True,
        "thaw_procedure": "Contact directly.",
        "notes": "",
        "citations": {"freeze_url": ["realpage-consumer"]},
        "sort_order": 61,
    },
    # ------------------------------------------------------------- employment
    {
...
REMINDER_TEMPLATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "detail": (
            "Free at annualcreditreport.com. Save each report in Identilock so "
